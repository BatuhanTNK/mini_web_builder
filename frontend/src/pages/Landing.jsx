...
const TEMPLATES = [
  ...
  { id: 'digital_rsvp', name: 'Davetiye (RSVP)', icon: '💌', desc: 'Dijital düğün ve nişan davetiyesi', color: '#db2777', category: 'Etkinlik' },
  { id: 'real_estate', name: 'Emlak İlanı', icon: '🏠', desc: 'Özel mülk ve gayrimenkul tanıtımı', color: '#fb923c', category: 'İşletme' },
  { id: 'course_registration', name: 'Kurs / Eğitim', icon: '🎓', desc: 'Online eğitim ve webinar kayıt', color: '#8b5cf6', category: 'İşletme' },
  { id: 'faq_support', name: 'SSS / Yardım', icon: '❓', desc: 'Müşteri destek merkezi ve SSS', color: '#3b82f6', category: 'İşletme' },
  { id: 'personal_trainer', name: 'Kişisel Antrenör', icon: '🏋️', desc: 'Fitness koçluğu ve diyet paketleri', color: '#ef4444', category: 'Portfolyo' },
