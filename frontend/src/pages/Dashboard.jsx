...
const TEMPLATES = [
  ...
  { id: 'digital_rsvp', name: 'Davetiye (RSVP)', icon: '💌', desc: 'Dijital davetiye', color: '#db2777' },
  { id: 'real_estate', name: 'Emlak İlanı', icon: '🏠', desc: 'Gayrimenkul portföyü', color: '#fb923c' },
  { id: 'course_registration', name: 'Kurs / Eğitim', icon: '🎓', desc: 'Webinar & kurs kayıt', color: '#8b5cf6' },
  { id: 'faq_support', name: 'SSS / Yardım', icon: '❓', desc: 'Müşteri destek sayfası', color: '#3b82f6' },
  { id: 'personal_trainer', name: 'Kişisel Antrenör', icon: '🏋️', desc: 'Fitness & antrenman paketi', color: '#ef4444' },
